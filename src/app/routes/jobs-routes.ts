...
import { POST_ANALYSIS_PROMPT } from '@/ai/prompts/post-analysis.prompt.js';
...
import { renderJobsListPage } from '@/app/views/jobs-list-page.js';
import {
    renderJobDetailsPage,
    renderJobNotFoundPage,
    type JobWithRelations,
} from '@/app/views/job-details-page.js';
